...
# app.config['SQLALCHEMY_DATABASE_URL']='mysql://username:password@localhost/hmdbms'
...
@login_required
def details():
    # posts=pharmacy.query.all()
    posts=db.engine.execute("SELECT * FROM `pharmacy`")
    return render_template('pharmacy.html',posts=posts)
